...
const char* ssid     = "C-IOT_wifi_rover ";
const char* password = "ciot@pesu";
...
<html>
  ...
  <body class="noselect" align="center" style="background-color:white">
    ...
    <h1 style="color: blue;text-align:center;">PES UNIVERSITY</h1>
    <h2 style="color: orange;text-align:center;">C - IOT</h2>
    <h3 style="color: orange;text-align:center;">ESP-32 Wi-Fi &#128663; Control</h3>
